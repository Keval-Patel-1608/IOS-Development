...
class TaskListVC: UIViewController {
    ...
    //MARK: - User Function
    // Configures the table view by setting the delegate, data source, and registering the cell
    ...
    // Shows or hides the table view and "No Task" label based on the given parameter
    ...
    // Checks for tasks that have reminders set for today and displays an alert
    ...
    // Displays an alert for tasks due today
...
extension TaskListVC: UITableViewDelegate, UITableViewDataSource {
    ...
    // Navigates to the task detail view when a task is selected
